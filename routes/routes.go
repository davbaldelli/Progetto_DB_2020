...
func (w Web) Listen() {
	...
	router.HandleFunc("/race/{race}/championship/{champ}/{year}/result", w.RacesHandler.GETRacesResult).Methods("GET")
	router.HandleFunc("/race/all", w.RacesHandler.GETAllRaces).Methods("GET")
